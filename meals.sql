...
-- ----------------------------
-- Table structure for certification_management
-- ----------------------------
DROP TABLE IF EXISTS `certification_management`;
CREATE TABLE `certification_management`  (
  `id` bigint NOT NULL,
  `merchant_id` bigint NULL DEFAULT NULL,
  `certification_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `certification_file_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `certification_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `certification_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of certification_management
-- ----------------------------
INSERT INTO `certification_management` VALUES (1890985306873008130, 1, '营业执照认证', '/path/to/file', '已通过', '2025-02-16 12:43:25');
INSERT INTO `certification_management` VALUES (1891064488424562689, 1, '营业执照认证', '/path/to/file', '已通过', '2025-02-16 17:58:03');

-- ----------------------------
-- Table structure for complaint_suggestion_management
-- ----------------------------
DROP TABLE IF EXISTS `complaint_suggestion_management`;
CREATE TABLE `complaint_suggestion_management`  (
  `id` bigint NOT NULL,
  ...
  `handling_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `handling_result` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `handling_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of complaint_suggestion_management
-- ----------------------------
INSERT INTO `complaint_suggestion_management` VALUES (1890985305908318210, '菜品问题', '菜品不新鲜', 1, '已处理', '无', '2025-02-16 12:43:24');
INSERT INTO `complaint_suggestion_management` VALUES (1891064488604917761, '菜品问题', '菜品不新鲜', 1, '已处理', '无', '2025-02-16 17:58:03');

-- ----------------------------
-- Table structure for customer_complaint_suggestion
-- ----------------------------
DROP TABLE IF EXISTS `customer_complaint_suggestion`;
CREATE TABLE `customer_complaint_suggestion`  (
  `id` bigint NOT NULL,
  `complaint_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `complaint_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
...
-- ----------------------------
-- Records of customer_complaint_suggestion
-- ----------------------------
INSERT INTO `customer_complaint_suggestion` VALUES (1890985306738790402, '服务问题', '服务员态度极差', 1, 1, '2025-02-16 12:43:25');
INSERT INTO `customer_complaint_suggestion` VALUES (1891064488479088641, '服务问题', '服务员态度极差', 1, 1, '2025-02-16 17:58:03');
...
-- ----------------------------
-- Table structure for evaluation_management
-- ----------------------------
DROP TABLE IF EXISTS `evaluation_management`;
CREATE TABLE `evaluation_management`  (
  `id` bigint NOT NULL,
  `evaluation_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `evaluator_id` bigint NULL DEFAULT NULL,
  `evaluated_object_id` bigint NULL DEFAULT NULL,
  `evaluated_object_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `evaluation_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of evaluation_management
-- ----------------------------
INSERT INTO `evaluation_management` VALUES (1890985306801704961, '服务非常好', 1, 1, '商家', '2025-02-16 12:43:25');
INSERT INTO `evaluation_management` VALUES (1891064488344870914, '服务非常好', 1, 1, '商家', '2025-02-16 17:58:03');
...
CREATE TABLE `merchant_audit`  (
  `id` bigint NOT NULL,
  `merchant_id` bigint NULL DEFAULT NULL,
  `audit_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (1854710014502547457, '1854710014502547457', 1, 1854706422592872449, 1854709985045950465, '2024-11-08 10:18:21', '2024-11-08 10:18:21', 2, 138.00, '', '15082513825', '13215', NULL, '杨自');
INSERT INTO `orders` VALUES (1890978541821378562, '1890978541821378562', 1, 1854706422592872449, 1854709985045950465, '2025-02-16 12:16:32', '2025-02-16 12:16:32', 2, 168.00, '', '15082513825', '13215', NULL, '杨自');
INSERT INTO `orders` VALUES (1892195901148405762, '1892195901148405762', 1, 1854881414601351170, 1892195820466774017, '2025-02-19 20:53:53', '2025-02-19 20:53:53', 1, 20.00, '', '18828807576', 'sjdhbd', '雷迪亚兹', 'lijufei');
...
-- Records of setmeal
-- ----------------------------
INSERT INTO `setmeal` VALUES (1415580119015145474, 1413386191767674881, '儿童套餐A计划', 4000.00, 1, '', '', '61d20592-b37f-4d72-a864-07ad5bb8f3bb.jpg', '2021-07-15 15:52:55', '2025-02-16 11:29:09', 1415576781934608386, 1, 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1854706422592872449, NULL, '15082513825', NULL, NULL, NULL, 1);
