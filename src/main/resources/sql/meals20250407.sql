...
CREATE TABLE `complaint`  (
  ...
  `complant_object_id` bigint NULL DEFAULT NULL COMMENT '评价对象的id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `complaint` VALUES (2342, '服务问题', '1', 1854706422592872449, '待审核', '马上处理相关人员', '2025-03-06 11:47:53', 1397849739276890114);
INSERT INTO `complaint` VALUES (1890985305908318210, '菜品问题', '菜品不新鲜', 1854706422592872449, '待处理', '无', '2025-02-16 12:43:24', 1397849739276890114);
INSERT INTO `complaint` VALUES (1891064488604917761, '菜品问题', '菜品不新鲜', 1854706422592872449, '待处理', '', '2025-02-16 17:58:03', 1397849739276890114);
INSERT INTO `complaint` VALUES (1896093411388809218, '套餐问题', '菜品不新鲜', 1854706422592872449, '未通过', '无', '2025-03-02 15:01:12', 1397849739276890114);
...
INSERT INTO `employee` VALUES (1908877718742216705, 1890985306738790125, '菜鸡蛋', 'caijidan', 'e10adc3949ba59abbe56e057f20f883e', '15082513825', '1', '513223200206561546', 1, '2025-04-06 21:41:28', '2025-04-06 21:41:28', 1890985306738790125, 1890985306738790125);
...
INSERT INTO `evaluation` VALUES (1908784998501683201, 'test', 1854706422592872449, 1890978541821378562, '订单', '2025-04-06 15:33:02', 5);
INSERT INTO `evaluation` VALUES (1908833719855624194, '1123', 1854706422592872449, 1854710014502547457, '订单', '2025-04-06 18:46:38', 3);
...
-- Records of merchant
-- ----------------------------
INSERT INTO `merchant` VALUES (1890985306738790121, '老成都火锅', '2000-05-16 01:27:55', '2010-09-09 00:40:27', 'username', 'e10adc3949ba59abbe56e057f20f883e');
INSERT INTO `merchant` VALUES (1890985306738790122, 'Gary Hunter', '2008-07-16 01:52:41', '2011-01-08 07:25:05', 'username1', 'e10adc3949ba59abbe56e057f20f883e');
INSERT INTO `merchant` VALUES (1890985306738790123, '麻辣香锅', '2025-03-19 15:37:59', '2025-03-19 15:38:02', 'username2', 'e10adc3949ba59abbe56e057f20f883e');
INSERT INTO `merchant` VALUES (1890985306738790124, 'Maruyama Daichi', '2017-11-11 02:04:42', '2019-06-14 15:50:50', 'username3', 'e10adc3949ba59abbe56e057f20f883e');
INSERT INTO `merchant` VALUES (1890985306738790125, 'Michelle Perry', '2012-08-02 02:45:10', '2006-10-07 00:45:43', 'username4', 'e10adc3949ba59abbe56e057f20f883e');
INSERT INTO `merchant` VALUES (1890985306738790128, '鲜嫩兔头', '2010-11-24 04:51:31', '2010-08-21 23:29:48', 'username5', 'e10adc3949ba59abbe56e057f20f883e');
INSERT INTO `merchant` VALUES (1904525941309751297, '隆江猪脚饭', '2025-03-25 21:29:03', '2025-03-25 21:29:03', 'username6', 'e10adc3949ba59abbe56e057f20f883e');
INSERT INTO `merchant` VALUES (1904531382730752000, 'AAA老王家火锅', '2025-03-25 21:50:41', '2025-03-25 21:50:41', 'username7', 'e10adc3949ba59abbe56e057f20f883e');
...
-- ----------------------------
INSERT INTO `merchant_audit` VALUES (1890985123456738791, 1890985306738790122, '待审核', '同意', NULL);
INSERT INTO `merchant_audit` VALUES (1890985306734590124, 1890985306738790124, ' 已通过 ', '同意审批', NULL);
INSERT INTO `merchant_audit` VALUES (1890985306738790122, 1890985306738790121, ' 已通过 ', '同意', NULL);
INSERT INTO `merchant_audit` VALUES (1890985306940116994, 1890985306738790123, ' 已通过 ', '同意审批', '2025-02-16 12:43:25');
INSERT INTO `merchant_audit` VALUES (1891064488542003202, 1890985306738790125, '待审核', '同意', '2025-02-16 17:58:03');
INSERT INTO `merchant_audit` VALUES (1896093412571602946, 1890985306738790128, ' 已通过 ', '不同意', '2025-03-02 15:01:12');
INSERT INTO `merchant_audit` VALUES (1904531386010697728, 1904531382730752000, ' 已通过 ', '同意审批', NULL);
...
-- ----------------------------
INSERT INTO `merchant_details` VALUES (1904531385989726208, 1904531382730752000, '杨自强', '15015211212', '男', '513263526526665965', '/common/download?name=604046f7-b6ce-4844-8289-2584de7a2fb1.png', '机场路十号攀枝花学院');
...
INSERT INTO `orders` VALUES (1905236593351446530, '1905236593351446530', 4, 1854881414601351170, 1892195820466774017, '2025-03-27 20:32:56', '2025-03-27 20:32:56', 2, 118.00, '', '18828807576', 'sjdhbd', '雷迪亚兹', 'lijufei', NULL);
INSERT INTO `orders` VALUES (1907039276676677633, '1907039276676677633', 4, 1907036803580821505, 1907039152416227330, '2025-04-01 19:56:09', '2025-04-01 19:56:09', 2, 118.00, '备注信息', '15082513825', '攀枝花学院', '辰基', '辰基', NULL);
INSERT INTO `orders` VALUES (1907041499380973569, '1907041499380973569', 4, 1907036803580821505, 1907039152416227330, '2025-04-01 20:04:59', '2025-04-01 20:04:59', 2, 138.00, '', '15082513825', '攀枝花学院', '辰基', '辰基', NULL);
INSERT INTO `orders` VALUES (1907042341148426242, '1907042341148426242', 4, 1907036803580821505, 1907039152416227330, '2025-04-01 20:08:20', '2025-04-01 20:08:20', 2, 146.00, '', '15082513825', '攀枝花学院', '辰基', '辰基', NULL);
INSERT INTO `orders` VALUES (1907043019388461057, '1907043019388461057', 4, 1907036803580821505, 1907039152416227330, '2025-04-01 20:11:02', '2025-04-01 20:11:02', 2, 138.00, '', '15082513825', '攀枝花学院', '辰基', '辰基', NULL);
INSERT INTO `orders` VALUES (1908888705356562433, '1908888705356562433', 2, 1854706422592872449, 1854709985045950465, '2025-04-06 22:25:07', '2025-04-06 22:25:07', 2, 45.00, '', '15082513825', '13215', 'rediaz', '杨自', NULL);
...
INSERT INTO `user` VALUES (1906703634319138818, NULL, '150825138925', NULL, NULL, NULL, 1);
INSERT INTO `user` VALUES (1907036803580821505, '辰基', '15082538251', '0', NULL, 'e667c96e-579e-4dda-a4c7-850ac3065a4f.png', 1);
